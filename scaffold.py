...
if remove_samples:
    ...
    os.remove('src/main/java/com/macuguita/modtemplate/fabric/datagen/ModRecipeProvider.java')
    yeet_line('src/main/java/com/macuguita/modtemplate/fabric/datagen/FabricDataGeneratorEntrypoint.java', 'sample_content')
    # Event/AWs/ATs
    os.remove('src/main/java/com/macuguita/modtemplate/ExampleEventHandler.java')
    yeet_line('src/main/java/com/macuguita/modtemplate/fabric/FabricEntrypoint.java', 'sample_content')
    yeet_line('src/main/java/com/macuguita/modtemplate/neoforge/NeoforgeEntrypoint.java', 'sample_content')
...
if mod_class != 'ModTemplate':
    ...
    os.rename('src/main/java/com/macuguita/modtemplate/ModTemplate.java',
              f'src/main/java/com/macuguita/modtemplate/{mod_class}.java')
